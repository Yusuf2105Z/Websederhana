...
class PemasukanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Alert::success('Berhasil','Terima kasih ' .$request->nama.' atas infaq yang telah di berikan , semoga allah swt memberikan balasan yang terbaik');
    ...
    public function destroy(Pemasukan $pemasukan)
    {
        ...
        Alert::success('Berhasil', 'Data Telah Berhasil');
        return redirect()->back();
    }
}
