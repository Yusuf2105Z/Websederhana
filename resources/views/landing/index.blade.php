<x-landing-layout>
    <div class="w-full" >
        {{-- <img class="w-full" src="{{asset('img/back-masjid.jpg')}}"" alt=""> --}}
    </div>
{{-- 
    <div class="w-full p-10">
        ...
        <div class="p-8 m-4 ml-0 bg-white rounded-md shadow-sm w-1/2">
            ...
            <table class="mt-8 table-auto border w-full">
                ...
                <tr>
                    <th class="text-left py-3 px-4 font-semibold">{{ $loop->iteration }}</th>
                    <th class="text-left py-3 px-4 font-semibold">{{ $d->created }}</th>
                    <th class="text-left py-3 px-4 font-semibold">{{ $d->nominal }}</th>
                </tr>
                @endforeach
                </tbody>
            </table>
